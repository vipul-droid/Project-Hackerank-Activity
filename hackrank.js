...
puppeteer.launch({
    ...
    // Input-1 is taking User id of hackerrank by which, so there is chances, that it didnot get logined by this id so in that case change it.
    return page.type("#input-1", "solosa9348@shzsedu.com");
}).then(function (){
    // Input-2 is password
    return page.type("#input-2", "789456123")
}).then(function () {
...
//  This function is for copy code from editorial and submit it in question area
